...
simpleAverage::simpleAverage(size_t numElements) {
...
void simpleAverage::add(int num) {
...
void simpleAverage::clear() {
  memset(_array, 0, _numElements * sizeof(int));
  _currentElement = 0;
}
